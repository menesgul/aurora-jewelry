        ...
        <div className="flex items-center gap-4 flex-1 w-full h-full">
          ...
          {showFilters && (
            <>
              ...
              <div className="fixed inset-0 z-50 bg-white p-4 flex flex-col gap-4 sm:hidden">
                <div className="flex justify-between items-center mb-2">
                  <span className="font-montserrat font-semibold text-lg">Filters</span>
                  <button onClick={() => setShowFilters(false)} className="text-[#E6CA97] text-2xl font-bold">×</button>
                </div>
                <form className="flex flex-col gap-4 flex-1" onSubmit={e => {e.preventDefault(); applyFilters(); setShowFilters(false);}}>
                  ...
                  <div className="flex gap-2 mt-2">
                    <button
                      type="submit"
                      className="w-full px-4 py-2 bg-[#E6CA97] text-white font-montserrat font-medium text-[15px] rounded-xl hover:bg-[#d6b97c] transition-colors duration-200"
                    >
                      Apply
                    </button>
                    <button
                      ...
                      className="w-full px-4 py-2 bg-gray-100 text-[#222] font-montserrat font-medium text-[15px] rounded-xl hover:bg-gray-200 transition-colors duration-200"
                    >
                      Clear
                    </button>
                  </div>
              ...
              {/* sm ve üstünde eski görünüm */}
              <form className="hidden sm:flex flex-wrap items-center gap-6 ml-4 h-[110px]" onSubmit={e => {e.preventDefault(); applyFilters();}}>
